export const contactButtons=()=>{
    function flipCover (css, options) {
      ...
      flipCover({
        css: "git",
        url: "https://github.com/abhinaykhalatkar",
        text: "Git",
        width: "90px",
      ...
      flipCover("teligram", {
        url: "https://www.t.me/abhinaykhalatkar",
        text: "Teligram",
        width: "90px"
      })
      
      flipCover("linkedin", {
        url: "https://www.linkedin.com/in/abhinay-khalatkar",
        text: "linkedin",
        width: "90px"
      })
      
      flipCover("facebook", {
      url:"https://www.facebook.com/urveshkhalatkar",
        text: "Facebook",
        width: "90px",
